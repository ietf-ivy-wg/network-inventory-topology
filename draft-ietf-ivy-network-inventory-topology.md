...
~~~~
{: sourcecode-markers="true" sourcecode-name="ietf-network-inventory-topology@2026-06-25.yang"}
...
{{Section 7 of !RFC8345}} for the underlying network topology data model.
